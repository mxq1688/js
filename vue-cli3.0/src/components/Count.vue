<template>
    <div>
        ...
        <div>
            {{ $store.state.Test.count }}-{{count}}
        </div>
        <div>
            getters: {{ $store.getters.gcount}}-{{gcount}}
        </div>
...
<script>
    ...
    export default {
        ...
        created(){
            ...
            window.console.log('mapState', mapState({count: state=> state.count, name: state=> state.name}))

            window.console.log('mapGetters', mapGetters(['gcount','name']))
            window.console.log('mapGetters', mapGetters({gcount: state=> state.count, name: state=> state.name}))
